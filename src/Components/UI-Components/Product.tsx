...
const ProductDetail:FC<P> = ({product})=>{
    ...
    <div className="h-56 my-2 relative w-full flex flex-col ">
      <AiTwotoneHeart size={20} className="absolute right-0 mt-2 mr-2 hover:text-red-600 text-white outline-1 " />
      <img
